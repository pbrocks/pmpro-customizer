...
function customize_controls_enqueue_scripts() {
	...
	wp_enqueue_script(
		$handle,
		plugin_dir_url( __FILE__ ) . 'inc/js/register-helper-setting.js',
	...
	wp_enqueue_script(
		$handle,
		plugin_dir_url( __FILE__ ) . 'inc/js/register-helper-control.js',
		array( 'customize-controls' ),
		time()
	);
	...
	wp_enqueue_script(
		$handle,
		plugin_dir_url( __FILE__ ) . 'inc/js/register-helper.js',
		array(
			'customize-controls',
